...
CONFIG = {
    ...
    "test_size": 0.2,
    "mlflow_tracking_uri": "https://dagshub.com/rahul-nayak01/ML-OPs-Model-deployment-Mini-project-.mlflow",
    "dagshub_repo_owner": "rahul-nayak01",
    "dagshub_repo_name": "ML-OPs-Model-deployment-Mini-project-",
